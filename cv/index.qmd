...
<div class="cv-actions">
  [Download CV (PDF)](/cv/current/Prakash_CV.pdf){.btn .btn-outline-primary}
  [Download Resume (PDF)](https://anoobvinu07.github.io/Resume_CV/Resume/1-page/prakash_resume_1page.pdf){.btn .btn-outline-primary}
</div>
:::
...
<div class="cv-actions">
  [Contact Me!](mailto:anoobvinu@gmail.com){.btn .btn-outline-primary}
</div>
...
- Data tools  
  - ArcGIS (advanced)  
  - QGIS (basic)  
  - tidyverse (proficient)
- Data analysis and bioinformatics  
- Management and analysis of large-scale genomic, phenotypic, and climate datasets
- Climate forecasting    
- Data visualization
:::
...
## Technical Skills  
Research computing, genomics, and reproducible workflows  
...
{{< include /includes/_education.qmd >}}
